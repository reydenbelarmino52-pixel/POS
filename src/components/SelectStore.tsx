    ...
    <div className="min-h-screen bg-[#FFF5F7] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 uppercase italic tracking-tight">Select Store</h1>
          <p className="text-slate-400 font-bold text-[10px] uppercase tracking-[0.2em] mt-2">Choose the terminal you wish to operate</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {stores.map((s) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-black text-slate-900 uppercase italic tracking-tight">{s.name}</p>
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">Active Node</p>
                </div>
              </div>
          ...
          >
            ...
            <span className="font-bold text-slate-400 group-hover:text-pink-500 uppercase tracking-widest text-[11px]">Deploy New Store</span>
          </motion.button>
        </div>
        ...
        <div className="mt-10 pt-10 border-t border-slate-100 text-center">
          <button 
            onClick={logout}
            className="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-pink-500 transition-colors"
          >
            Terminal Override (Sign Out)
          </button>
        </div>
      </motion.div>
    </div>
